...
then returns an array where the first element is the sum of those numbers, and the
...
it is finished, uncomment the call for the testSum() function below and check the 
console to see if the test passes.*/
...
an array where the first element is the product of those numbers, and the second element 
...
use your sum() function, and to do multiplication, use your multiply() function that you've already
 created. You're going to have to be resourceful to figure out how to do this. However, you may 
...
function sumArray(sumArr) { //eslint-disable-line
  var partialSum = sum(sumArr[0], sumArr[1]); //working
  var totalSum = sum(partialSum[0], sumArr[2]); //sum instead of testArray
  ...
  return [
    totalSum[0],
    '2,3,4 was passed in as an array of numbers, and ' + totalSum[0] + ' is their sum.'
  ];
  }
...
// You're done! Submit the link to the repo following the instructions in Canvas. Or, try out 
